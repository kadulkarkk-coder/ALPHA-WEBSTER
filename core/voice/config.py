...
class VoiceConfig:
    """Voice settings optimized for a hands-free Windows assistant."""
    ...
    def __post_init__(self) -> None:
        ...
        self.chunk_size = max(160, int(self.chunk_size))
        ...
        self.calibration_seconds = max(0.15, float(self.calibration_seconds))
