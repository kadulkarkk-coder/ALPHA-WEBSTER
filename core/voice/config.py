...
class VoiceConfig:
    ...
    listen_timeout: float=8.0; max_phrase_seconds: float=12.0; silence_duration: float=0.85; pre_roll_seconds: float=0.25; start_blocks: int=2
